 ...
 * # Int Deque Base
 *
 * Base, templated type backing the `IntDeque` class.
 *
...
abstract class AbstractIntDeque<D : AbstractIntDeque<D>> {

  protected var container: IntArray
  ...
  constructor(initCapacity: Int = 0) {
    container = IntArray(initCapacity)
    size = 0
    realHead = 0
  }
  ...
  protected constructor(values: IntArray, head: Int) {
    container = values
    size = values.size
    realHead = head
  }
   ...
   */
  protected abstract fun new(values: IntArray, head: Int): D
  ...
  fun ensureCapacity(minCapacity: Int) {
    when {
      ...
      container.isEmpty()           -> container = IntArray(minCapacity)
   ...
   */
  fun copyInto(array: IntArray, offset: Int = 0, len: Int = array.size - offset): Int {
   ...
   * greater than [size], or if [start] is greater than [end].
   */
  fun sliceToArray(start: Int, end: Int): IntArray {
    ...
    when (realSize) {
      0    -> return IntArray(0)
      1    -> return IntArray(1) { container[internalIndex(start)] }
      size -> return toArray()
    }
   ...
   */
  operator fun plus(rhs: AbstractIntDeque<*>) =
    new(IntArray(size + rhs.size).also { copyInto(it); rhs.copyInto(it, size) }, 0)
   ...
   */
  inline fun firstOr(value: Int) = frontOr(value)
   ...
   */
  inline fun lastOr(value: Int) = backOr(value)
   ...
   */
  fun iterator() = object : ListIterator<Int> {
    var position = -1
   ...
   */
  inline fun pushFirst(value: Int) = pushFront(value)
   ...
   */
  fun pushBack(values: Collection<Int>) {
   ...
   */
  fun pushBack(values: AbstractIntDeque<*>) {
   ...
   */
  inline fun pushLast(value: Int) = pushBack(value)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: IntArray) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: Collection<Int>) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: AbstractIntDeque<*>) = pushBack(values)
   ...
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(value: Int) = pushBack(value)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: IntArray) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: Collection<Int>) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: AbstractIntDeque<*>) = pushBack(values)
   ...
   * is greater than [lastIndex].
   */
  operator fun set(index: Int, value: Int) = container.set(vei(index), value)
   ...
   */
  inline fun popFirstOr(value: Int) = popFrontOr(value)
   ...
   */
  inline fun popLastOr(value: Int) = popBackOr(value)
  ...
  override fun toString() = "IntDeque($size/${container.size})"

  override fun equals(other: Any?) =
    if (other is AbstractIntDeque<*>)
