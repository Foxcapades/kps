 ...
 * # ULong Deque Base
 *
 * Base, templated type backing the `ULongDeque` class.
 *
...
abstract class AbstractULongDeque<D : AbstractULongDeque<D>> {

  protected var container: ULongArray
  ...
  constructor(initCapacity: Int = 0) {
    container = ULongArray(initCapacity)
    size = 0
    realHead = 0
  }

  constructor(values: ULongArray) {
    container = values.copyOf()
    size = values.size
    realHead = 0
  }

  protected constructor(values: ULongArray, head: Int) {
    container = values
    size = values.size
    realHead = head
  }
   ...
   */
  protected abstract fun new(values: ULongArray, head: Int): D
  ...
  fun ensureCapacity(minCapacity: Int) {
    when {
      ...
      container.isEmpty()           -> container = ULongArray(minCapacity)
   ...
   */
  fun copyInto(array: ULongArray, offset: Int = 0, len: Int = array.size - offset): Int {
   ...
   * greater than [size], or if [start] is greater than [end].
   */
  fun sliceToArray(start: Int, end: Int): ULongArray {
    ...
    // Shortcuts
    when (realSize) {
      0    -> return ULongArray(0)
      1    -> return ULongArray(1) { container[internalIndex(start)] }
      size -> return toArray()
    }
   ...
   */
  operator fun plus(rhs: AbstractULongDeque<*>) =
    new(ULongArray(size + rhs.size).also { copyInto(it); rhs.copyInto(it, size) }, 0)
   ...
   */
  inline fun firstOr(value: ULong) = frontOr(value)
   ...
   */
  inline fun lastOr(value: ULong) = backOr(value)
   ...
   */
  fun iterator() = object : ListIterator<ULong> {
    var position = -1
   ...
   */
  inline fun pushFirst(value: ULong) = pushFront(value)
   ...
   */
  fun pushBack(values: ULongArray) {
   ...
   */
  fun pushBack(values: Collection<ULong>) {
   ...
   */
  fun pushBack(values: AbstractULongDeque<*>) {
   ...
   */
  inline fun pushLast(value: ULong) = pushBack(value)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: ULongArray) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: Collection<ULong>) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: AbstractULongDeque<*>) = pushBack(values)
   ...
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(value: ULong) = pushBack(value)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: ULongArray) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: Collection<ULong>) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: AbstractULongDeque<*>) = pushBack(values)
   ...
   * is greater than [lastIndex].
   */
  operator fun set(index: Int, value: ULong) = container.set(vei(index), value)
   ...
   * deque was empty.
   */
  fun popFrontOr(value: ULong): ULong {
    if (size == 0)
      return value
   ...
   */
  inline fun popFirstOr(value: ULong) = popFrontOr(value)
   ...
   * deque was empty.
   */
  fun popBackOr(value: ULong): ULong {
    if (size == 0)
      return value
  ...
  override fun toString() = "ULongDeque($size/${container.size})"

  override fun equals(other: Any?) =
    if (other is AbstractULongDeque<*>)
