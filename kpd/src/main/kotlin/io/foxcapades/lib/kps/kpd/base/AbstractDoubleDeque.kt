 ...
 * # Double Deque Base
 *
 * Base, templated type backing the `DoubleDeque` class.
 *
...
abstract class AbstractDoubleDeque<D : AbstractDoubleDeque<D>> {

  protected var container: DoubleArray
  ...
  constructor(initCapacity: Int = 0) {
    container = DoubleArray(initCapacity)
    size = 0
    realHead = 0
  }
  ...
  protected constructor(values: DoubleArray, head: Int) {
    container = values
    size = values.size
    realHead = head
  }
   ...
   */
  protected abstract fun new(values: DoubleArray, head: Int): D
   ...
   */
  fun copyInto(array: DoubleArray, offset: Int = 0, len: Int = array.size - offset): Int {
   ...
   * greater than [size], or if [start] is greater than [end].
   */
  fun sliceToArray(start: Int, end: Int): DoubleArray {
   ...
   */
  operator fun plus(rhs: AbstractDoubleDeque<*>) =
    new(DoubleArray(size + rhs.size).also { copyInto(it); rhs.copyInto(it, size) }, 0)
   ...
   */
  inline fun firstOr(value: Double) = frontOr(value)
   ...
   */
  inline fun lastOr(value: Double) = backOr(value)
   ...
   */
  fun iterator() = object : ListIterator<Double> {
    var position = -1
   ...
   */
  inline fun pushFirst(value: Double) = pushFront(value)
   ...
   */
  fun pushBack(values: DoubleArray) {
   ...
   */
  fun pushBack(values: Collection<Double>) {
   ...
   */
  fun pushBack(values: AbstractDoubleDeque<*>) {
   ...
   */
  inline fun pushLast(value: Double) = pushBack(value)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: DoubleArray) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: Collection<Double>) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: AbstractDoubleDeque<*>) = pushBack(values)
   ...
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(value: Double) = pushBack(value)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: DoubleArray) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: Collection<Double>) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: AbstractDoubleDeque<*>) = pushBack(values)
   ...
   * is greater than [lastIndex].
   */
  operator fun set(index: Int, value: Double) = container.set(vei(index), value)
   ...
   * deque was empty.
   */
  fun popFrontOr(value: Double): Double {
    if (size == 0)
      return value
   ...
   */
  inline fun popFirstOr(value: Double) = popFrontOr(value)
   ...
   * deque was empty.
   */
  fun popBackOr(value: Double): Double {
    if (size == 0)
      return value
   ...
   */
  inline fun popLastOr(value: Double) = popBackOr(value)
  ...
  override fun toString() = "DoubleDeque($size/${container.size})"

  override fun equals(other: Any?) =
    if (other is AbstractDoubleDeque<*>)
