...
import io.foxcapades.lib.kps.kpd.base.AbstractByteDeque
 ...
 * @since v1.0.0
 */
class ByteDeque : PrimitiveDeque, AbstractByteDeque<ByteDeque> {
   ...
   */
  constructor(values: ByteArray) : super(values)

  private constructor(values: ByteArray, head: Int) : super(values, head)

  override fun new(values: ByteArray, head: Int) = ByteDeque(values, head)
   ...
   * called.
   */
  fun popUByte(): UByte = popFront().toUByte()
