 ...
 * # Long Deque Base
 *
 * Base, templated type backing the `LongDeque` class.
 *
...
abstract class AbstractLongDeque<D : AbstractLongDeque<D>> {

  protected var container: LongArray
  ...
  constructor(initCapacity: Int = 0) {
    container = LongArray(initCapacity)
    size = 0
    realHead = 0
  }
  ...
  protected constructor(values: LongArray, head: Int) {
    container = values
    size = values.size
    realHead = head
  }
   ...
   */
  protected abstract fun new(values: LongArray, head: Int): D
  ...
  fun ensureCapacity(minCapacity: Int) {
    when {
      ...
      container.isEmpty()           -> container = LongArray(minCapacity)
   ...
   */
  fun copyInto(array: LongArray, offset: Int = 0, len: Int = array.size - offset): Int {
   ...
   * greater than [size], or if [start] is greater than [end].
   */
  fun sliceToArray(start: Int, end: Int): LongArray {
    ...
    // Shortcuts
    when (realSize) {
      0    -> return LongArray(0)
      1    -> return LongArray(1) { container[internalIndex(start)] }
      size -> return toArray()
    }
   ...
   */
  operator fun plus(rhs: AbstractLongDeque<*>) =
    new(LongArray(size + rhs.size).also { copyInto(it); rhs.copyInto(it, size) }, 0)
   ...
   */
  inline fun firstOr(value: Long) = frontOr(value)
   ...
   */
  inline fun lastOr(value: Long) = backOr(value)
   ...
   */
  fun iterator() = object : ListIterator<Long> {
    var position = -1
   ...
   */
  inline fun pushFirst(value: Long) = pushFront(value)
   ...
   */
  fun pushBack(values: Collection<Long>) {
   ...
   */
  fun pushBack(values: AbstractLongDeque<*>) {
   ...
   */
  inline fun pushLast(value: Long) = pushBack(value)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: LongArray) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: Collection<Long>) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: AbstractLongDeque<*>) = pushBack(values)
   ...
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(value: Long) = pushBack(value)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: LongArray) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: Collection<Long>) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: AbstractLongDeque<*>) = pushBack(values)
   ...
   * is greater than [lastIndex].
   */
  operator fun set(index: Int, value: Long) = container.set(vei(index), value)
   ...
   * deque was empty.
   */
  fun popFrontOr(value: Long): Long {
    if (size == 0)
      return value
   ...
   */
  inline fun popFirstOr(value: Long) = popFrontOr(value)
   ...
   */
  inline fun popLastOr(value: Long) = popBackOr(value)
  ...
  override fun toString() = "LongDeque($size/${container.size})"

  override fun equals(other: Any?) =
    if (other is AbstractLongDeque<*>)
