 ...
 * # Byte Deque Base
 *
 * Base, templated type backing the `ByteDeque` class.
 *
...
abstract class AbstractByteDeque<D : AbstractByteDeque<D>> {

  protected var container: ByteArray
  ...
  constructor(initCapacity: Int = 0) {
    container = ByteArray(initCapacity)
    size = 0
    realHead = 0
  }
  ...
  protected constructor(values: ByteArray, head: Int) {
    container = values
    size = values.size
    realHead = head
  }
   ...
   */
  protected abstract fun new(values: ByteArray, head: Int): D
   ...
   */
  fun copyInto(array: ByteArray, offset: Int = 0, len: Int = array.size - offset): Int {
   ...
   * greater than [size], or if [start] is greater than [end].
   */
  fun sliceToArray(start: Int, end: Int): ByteArray {
   ...
   */
  operator fun plus(rhs: AbstractByteDeque<*>) =
    new(ByteArray(size + rhs.size).also { copyInto(it); rhs.copyInto(it, size) }, 0)
   ...
   */
  inline fun firstOr(value: Byte) = frontOr(value)
   ...
   */
  inline fun lastOr(value: Byte) = backOr(value)
   ...
   */
  fun iterator() = object : ListIterator<Byte> {
    var position = -1
   ...
   */
  inline fun pushFirst(value: Byte) = pushFront(value)
   ...
   */
  fun pushBack(values: Collection<Byte>) {
   ...
   */
  fun pushBack(values: AbstractByteDeque<*>) {
   ...
   */
  inline fun pushLast(value: Byte) = pushBack(value)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: ByteArray) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: Collection<Byte>) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline fun pushLast(values: AbstractByteDeque<*>) = pushBack(values)
   ...
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(value: Byte) = pushBack(value)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: ByteArray) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: Collection<Byte>) = pushBack(values)

  /**
   * Inline alias of [pushBack]
   */
  inline operator fun plusAssign(values: AbstractByteDeque<*>) = pushBack(values)
   ...
   * is greater than [lastIndex].
   */
  operator fun set(index: Int, value: Byte) = container.set(vei(index), value)
   ...
   * deque was empty.
   */
  fun popFrontOr(value: Byte): Byte {
    if (size == 0)
      return value
   ...
   */
  inline fun popFirstOr(value: Byte) = popFrontOr(value)
  ...
  override fun toString() = "ByteDeque($size/${container.size})"

  override fun equals(other: Any?) =
    if (other is AbstractByteDeque<*>)
